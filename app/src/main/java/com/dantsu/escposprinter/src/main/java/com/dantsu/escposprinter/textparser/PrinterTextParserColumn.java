...
import com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.EscPosPrinter;
import com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParser;
import com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter. textparser.PrinterTextParserLine;
...
public class PrinterTextParserColumn {
    ...
    private com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[] elements = new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[0];
     ...
     */
    public PrinterTextParserColumn(com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserLine textParserLine, String textColumn) throws EscPosParserException, EscPosBarcodeException, EscPosEncodingException {
        ...
        if (this.textParserLine.getNbrColumns() == 1 && trimmedTextColumn.indexOf("<") == 0) {
            ...
            if (openTagIndex < openTagEndIndex) {
                com.dantsu.escposprinter.textparser.PrinterTextParserTag textParserTag = new com.dantsu.escposprinter.textparser.PrinterTextParserTag(trimmedTextColumn.substring(openTagIndex, openTagEndIndex));
        ...
        if (!isImgOrBarcodeLine) {
            ...
            while (true) {
                ...
                closeTagIndex++;
                com.dantsu.escposprinter.textparser.PrinterTextParserTag textParserTag = new com.dantsu.escposprinter.textparser.PrinterTextParserTag(textColumn.substring(openTagIndex, closeTagIndex));
            ...
            for (com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement textParserElement : this.elements) {
    ...
    private PrinterTextParserColumn prependString(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) {
        return this.prependElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserString(this, text, textSize, textColor, textReverseColor, textBold, textUnderline, textDoubleStrike));
    }
    ...
    private PrinterTextParserColumn appendString(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) {
        ...
        return this.appendElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserString(this, text, textSize, textColor, textReverseColor, textBold, textUnderline, textDoubleStrike));
    }

    private PrinterTextParserColumn prependImage(String textAlign, String hexString) {
        return this.prependElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserImg(this, textAlign, hexString));
    }

    private PrinterTextParserColumn appendImage(String textAlign, String hexString) {
        return this.appendElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserImg(this, textAlign, hexString));
    }
    ...
    private PrinterTextParserColumn prependBarcode(String textAlign, Hashtable<String, String> barcodeAttributes, String code) throws EscPosParserException, EscPosBarcodeException {
        return this.prependElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserBarcode(this, textAlign, barcodeAttributes, code));
    }
    ...
    private PrinterTextParserColumn appendBarcode(String textAlign, Hashtable<String, String> barcodeAttributes, String code) throws EscPosParserException, EscPosBarcodeException {
        return this.appendElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserBarcode(this, textAlign, barcodeAttributes, code));
    }
    ...
    private PrinterTextParserColumn prependQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException, EscPosBarcodeException {
        return this.prependElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserBarcode(this, textAlign, qrCodeAttributes, data));
    }
    ...
    private PrinterTextParserColumn appendQRCode(String textAlign, Hashtable<String, String> qrCodeAttributes, String data) throws EscPosParserException, EscPosBarcodeException {
        return this.appendElement(new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.PrinterTextParserQRCode(this, textAlign, qrCodeAttributes, data));
    }

    private PrinterTextParserColumn prependElement(com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter. textparser.IPrinterTextParserElement element) {
        com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[] elementsTmp = new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[this.elements.length + 1];
    ...
    private PrinterTextParserColumn appendElement(com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter. textparser.IPrinterTextParserElement element) {
        com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[] elementsTmp = new com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[this.elements.length + 1];
    ...
    public com.dantsu.escposprinter.src.main.java.com.dantsu.escposprinter.textparser.IPrinterTextParserElement[] getElements() {
